...
csvFile = open('astroworld_raw_location.csv', 'w')
csvWriter = csv.writer(csvFile,delimiter ='|')

csvWriter.writerow(['author id', 'username', 'created_at', 'geo', 'id','lang', 'like_count', 'quote_count', 'reply_count','retweet_count','source','tweet', "place"])
...
while startday < 13:
    ...
    while starthour < 23:
        ...
        for tweet in json_response['data']:
            ...
            res = [author_id, username, created_at, geo, tweet_id, lang, like_count, quote_count, reply_count, retweet_count, source, text, place]
